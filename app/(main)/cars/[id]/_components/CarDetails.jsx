...
import { toggleSavedCar } from "@/actions/carList";
    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on CarSahulat`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>CarSahulat Car Loan Calculator</DialogTitle>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              ...
              <a href="mailto:help@CarSahulat.in">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">CarSahulat Motors</h4>
