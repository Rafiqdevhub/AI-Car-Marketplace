            ...
            <div className="space-y-3">
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <span className="text-gray-700 dark:text-gray-300">PKR</span>
                </div>
                <input
                  type="number"
                  value={loanAmount}
                  ...
                  className="w-full pl-16 pr-4 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-gray-900 dark:focus:border-gray-400"
                />
              </div>
              <input
                type="range"
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg md:col-span-2">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                    {formatCurrency(
                      parseFloat(results?.downPayment || 0) +
                        parseFloat(results?.totalPayment || 0)
                    )}
                  </div>
                </div>
              </div>
