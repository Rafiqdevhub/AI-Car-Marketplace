...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'CarSahulat',
    "address" TEXT NOT NULL DEFAULT '123 Main St, Peshawar, Pakistan',
    "phone" TEXT NOT NULL DEFAULT '+923129185825',
    "email" TEXT NOT NULL DEFAULT 'contact@carsahulat.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
